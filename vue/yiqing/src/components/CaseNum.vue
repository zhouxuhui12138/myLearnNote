<template>
  <div class="case-num">
    <div class="container">
      <div class="title">
        <span>截止 {{ caseNumDate.modifyTime | formatData }} 全国数据统计</span>
      </div>
    </div>
            ...
            <div class="create-count">
              <b>
                ...
                <em style="color: rgb(247, 76, 49)">
                  {{ caseNumDate.currentConfirmedIncr }}
                </em>
              </b>
            </div>
            <strong style="color: rgb(247, 76, 49)">
              {{ caseNumDate.currentConfirmedCount }}
            </strong>
            <span>现存确诊</span>
          </div>
        </li>
            ...
            <div class="create-count">
              <b>
                ...
                <em style="color: rgb(247, 130, 7)">
                  {{ caseNumDate.suspectedIncr }}
                </em>
              </b>
            </div>
            <strong style="color: rgb(247, 130, 7)">
              {{ caseNumDate.suspectedCount }}
            </strong>
            <span>境外输入</span>
          </div>
        </li>
            ...
            <div class="create-count">
              <b>
                ...
                <em style="color: rgb(162, 90, 78)">
                  {{ caseNumDate.seriousIncr }}
                </em>
              </b>
            </div>
            <strong style="color: rgb(162, 90, 78)">
              {{ caseNumDate.seriousCount }}
            </strong>
            <span>现存无症状</span>
          </div>
        </li>
            ...
            <div class="create-count">
              <b>
                ...
                <em style="color: rgb(174, 33, 44)">
                  {{ caseNumDate.confirmedIncr }}
                </em>
              </b>
            </div>
            <strong style="color: rgb(174, 33, 44)">
              {{ caseNumDate.confirmedCount }}
            </strong>
            <span>累计确诊</span>
          </div>
        </li>
            ...
            <div class="create-count">
              <b>
                ...
                <em style="color: rgb(93, 112, 146)">
                  {{ caseNumDate.deadIncr }}
                </em>
              </b>
            </div>
            <strong style="color: rgb(93, 112, 146)">
              {{ caseNumDate.deadCount }}
            </strong>
            <span>累计死亡</span>
          </div>
        </li>
            ...
            <div class="create-count">
              <b>
                ...
                <em style="color: rgb(40, 183, 163)">
                  {{ caseNumDate.curedIncr }}
                </em>
              </b>
            </div>
            <strong style="color: rgb(40, 183, 163)">
              {{ caseNumDate.curedCount }}
            </strong>
            <span>累计治愈</span>
          </div>
        </li>
